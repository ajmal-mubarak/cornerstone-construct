        ...
        <div className="container-custom">
          <div className="grid gap-12 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5 space-y-5">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                {OFFICES.map((item, idx) => (
                  <Reveal key={item.title} delay={idx * 0.05}>
                    <div className="palette-card rounded-2xl p-5 border border-[#E2E8F0] transition-all hover:border-[#285A7E]">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="rounded-full bg-[#F1F5F9] px-2.5 py-0.5 text-[0.625rem] font-bold text-[#285A7E] border border-[#E2E8F0]">
                          {item.badge}
                        </span>
                      </div>

                      <h3 className="mt-4 font-display text-base font-bold text-[#1E2730]">
                        {item.title}
                      </h3>

                      <div className="mt-1 space-y-0.5">
                        {item.lines.map((line) => (
                          <p key={line} className="text-xs text-[#64748B]">
                            {line}
                          </p>
                        ))}
                      </div>
              ...
              <Reveal delay={0.25}>
                <div className="rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] p-5">
                  ...
                  <p className="text-sm font-bold text-[#1E2730]">Sunday to Thursday: 07:30 – 17:30</p>
                  <p className="text-xs text-[#64748B] mt-1">24/7 site operations support for active contracts.</p>
                </div>
              </Reveal>
            </div>
            ...
            <div className="lg:col-span-7">
              <Reveal delay={0.1}>
                <div className="palette-card rounded-3xl p-8 sm:p-10 border border-[#E2E8F0] shadow-sm relative overflow-hidden bg-white">
                  ...
                  <h3 className="font-display text-2xl font-bold text-[#1E2730] sm:text-3xl">
                  ...
                  {sent ? (
                    <div className="mt-8 rounded-2xl border border-[#285A7E]/30 bg-[#F8FAFC] p-8 text-center">
                      ...
                      <h4 className="font-display text-2xl font-bold text-[#1E2730]">
                        Enquiry Successfully Received!
                      </h4>
                      <p className="mt-2 text-sm leading-relaxed text-[#475569] max-w-md mx-auto">
                      ...
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        className="mt-6 border-[#E2E8F0] text-[#1E2730] hover:bg-[#F1F5F9]"
                      >
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        <Label className="text-xs font-semibold text-[#1E2730]">
                          Select Relevant Division / Scope *
                        </Label>
                        <select
                          value={selectedDept}
                          onChange={(e) => setSelectedDept(e.target.value)}
                          className="w-full rounded-xl border border-[#E2E8F0] bg-white px-4 py-3 text-sm text-[#1E2730] focus:border-[#285A7E] focus:outline-none focus:ring-1 focus:ring-[#285A7E]"
                        >
                          {DEPARTMENTS.map((dept) => (
                            <option key={dept} value={dept} className="bg-white text-[#1E2730]">
                              {dept}
                            </option>
                          ))}
                        </select>
                      ...
                      <div className="grid gap-5 sm:grid-cols-2">
                        <div className="space-y-2">
                          <Label htmlFor="name" className="text-xs font-semibold text-[#1E2730]">
                            Your Full Name *
                          </Label>
                          <Input
                            id="name"
                            ...
                            className="border-[#E2E8F0] bg-white text-[#1E2730] placeholder:text-[#94A3B8] rounded-xl py-3 focus-visible:ring-[#285A7E]"
                          />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="company" className="text-xs font-semibold text-[#1E2730]">
                      ...
                      <div className="grid gap-5 sm:grid-cols-2">
                        <div className="space-y-2">
                          <Label htmlFor="email" className="text-xs font-semibold text-[#1E2730]">
                            Corporate Email *
                          </Label>
                          <Input
                            id="email"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="phone" className="text-xs font-semibold text-[#1E2730]">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="message" className="text-xs font-semibold text-[#1E2730]">
                        ...
                        <Textarea
                          ...
                          className="border-[#E2E8F0] bg-white text-[#1E2730] placeholder:text-[#94A3B8] rounded-xl focus-visible:ring-[#285A7E]"
                        />
                      </div>
                      ...
                      <p className="text-center text-[0.6875rem] text-[#64748B]">
